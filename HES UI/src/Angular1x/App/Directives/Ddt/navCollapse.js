'use strict'
app.directive('navCollapse', ['$timeout', function ($timeout) {
    return {
        restrict: 'A',
        link: function ($scope, $el) {
            ...
            $timeout(function () {
                ...
                //Hide Menu on item click in mobile view. 
                $dropdowns.children('ul').parent('li').on('click', function (event) {
                    if (app.hasClass('sidebar-sm') || app.hasClass('sidebar-xs')) {
